...
(cl:defmethod cl:initialize-instance :after ((m <ExecuteCartesianIKTrajectory-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExecuteCartesianIKTrajectory-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2lib-srv:<ExecuteCartesianIKTrajectory-request> is deprecated: use pr2lib-srv:ExecuteCartesianIKTrajectory-request instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ExecuteCartesianIKTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2lib-srv:header-val is deprecated.  Use pr2lib-srv:header instead.")
  (header m))

(cl:ensure-generic-function 'poses-val :lambda-list '(m))
(cl:defmethod poses-val ((m <ExecuteCartesianIKTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2lib-srv:poses-val is deprecated.  Use pr2lib-srv:poses instead.")
  (poses m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExecuteCartesianIKTrajectory-request>)))
  ...
  "pr2lib/ExecuteCartesianIKTrajectoryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExecuteCartesianIKTrajectory-request)))
  "Returns string type for a service object of type 'ExecuteCartesianIKTrajectory-request"
  "pr2lib/ExecuteCartesianIKTrajectoryRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ExecuteCartesianIKTrajectory-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExecuteCartesianIKTrajectory-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pr2lib-srv:<ExecuteCartesianIKTrajectory-response> is deprecated: use pr2lib-srv:ExecuteCartesianIKTrajectory-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ExecuteCartesianIKTrajectory-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pr2lib-srv:success-val is deprecated.  Use pr2lib-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExecuteCartesianIKTrajectory-response>)))
  ...
  "pr2lib/ExecuteCartesianIKTrajectoryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExecuteCartesianIKTrajectory-response)))
  "Returns string type for a service object of type 'ExecuteCartesianIKTrajectory-response"
  "pr2lib/ExecuteCartesianIKTrajectoryResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExecuteCartesianIKTrajectory)))
  ...
  "pr2lib/ExecuteCartesianIKTrajectory")